...
int Aggregator_distinct::key_cmp(void* arg, const uchar* key1, const uchar* key2)
{
...
{
  ORDER **order_item_ptr, **end;

  for (order_item_ptr= order_list, end=order_list+ order_count;
       order_item_ptr < end;
       order_item_ptr++)
  {
                                     ...
                                     const void *key2)
{
  ...
  return group_concat_order_list_comparison(
      grp_item->order, grp_item->arg_count_order, (const uchar *) key1,
      (const uchar *) key2, true);
}
